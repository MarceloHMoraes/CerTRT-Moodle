...
$string['borderstyle_help'] = 'The Border Image option allows you to choose a border image from the certrt/pix/borders folder.  Select the border image that you want around the certificate edges or select no border.';
$string['certrt'] = 'Verification for certificate code:';
$string['certrt:addinstance'] = 'Add a certificate instance';
$string['certrt:manage'] = 'Manage a certificate instance';
$string['certrt:printteacher'] = 'Be listed as a teacher on the certificate if the print teacher setting is on';
$string['certrt:student'] = 'Retrieve a certificate';
$string['certrt:view'] = 'View a certificate';
$string['certrtname'] = 'Certificate Name';
$string['certrtreport'] = 'Certificates Report';
$string['certrtsfor'] = 'Certificates for';
$string['certrttype'] = 'Certificate Type';
$string['certrttype_help'] = 'This is where you determine the layout of the certificate. The certificate type folder includes four default certificates:
...
New type folders can be added to the certrt/type folder. The name of the folder and any new language strings for the new type must be added to the certificate language file.';
...
$string['credithourstype'] = 'credit hours';
...
$string['deletissuedcertrts'] = 'Delete issued certificates';
...
{$a->student} has received their certificate: \'{$a->certrt}\'
for {$a->course}.
...
{$a->student} has received their certificate: \'<i>{$a->certrt}</i>\'
for {$a->course}.
...
$string['getcertrt'] = 'Get your certificate';
$string['grade'] = 'Grade';
...
$string['mycertrts'] = 'My certificates';
$string['nocertrts'] = 'There are no certificates';
$string['nocertrtsissued'] = 'There are no certificates that have been issued';
$string['nocertrtsreceived'] = 'has not received any course certificates.';
...
$string['printseal_help'] = 'This option allows you to select a seal or logo to print on the certificate from the certrt/pix/seals folder. By default, this image is placed in the lower right corner of the certificate.';
$string['printsignature'] = 'Signature Image';
$string['printsignature_help'] = 'This option allows you to print a signature image from the certrt/pix/signatures folder.  You can print a graphic representation of a signature, or print a line for a written signature. By default, this image is placed in the lower left of the certificate.';
...
$string['reviewcertrt'] = 'Review your certificate';
...
$string['secondpage'] = 'Certificate backpage'; 
$string['secondpage_help'] = 'Insert here the backpage text to be printed. You should use the inbox HTML editor to format your text accordingly. If you intend to print a certificate with the backpage, make sure your printer is configured to print 2-sides, because the certificate is 2-pages lenght.'; 
...
$string['title'] = 'CERTIFCATE of ACHIEVEMENT';
...
$string['verifycertrt'] = 'Verify certificate';
$string['viewcertrtviews'] = 'View {$a} issued certificates';
