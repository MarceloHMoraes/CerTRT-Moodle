...
$modY += 19;
certrt_print_text($pdf, $x, $modY, 'J', 'Times' , '', 18, $certrt->customtext);
...
// mhz - validation code
certrt_print_text($pdf, $codex, $codey, 'R', 'Times' , '', 10, 'C&oacute;digo de valida&ccedil;&atilde;o: ' . certrt_get_code($certrt, $certrecord));
